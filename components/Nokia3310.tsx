...
const Nokia3310: React.FC = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen p-4">
      ...
      <div className="relative z-10 rounded-[3rem] bg-red-950 p-2 shadow-2xl">
        
        {/* Main Casing - Red Classic */}
        <div className="
            relative
            w-[340px] h-[680px]
            bg-[#C41E3A]
            rounded-[2.5rem]
            border-[4px] border-[#8B1A2A]
            shadow-[inset_0_10px_30px_rgba(255,255,255,0.15),inset_0_-10px_30px_rgba(0,0,0,0.4)]
            flex flex-col items-center
            overflow-hidden
        ">
            {/* Top Curve Accent (The 3310 'forehead') */}
            <div className="absolute top-0 w-full h-28 bg-[#C41E3A] rounded-t-[2.5rem] flex flex-col items-center justify-start pt-8 z-0">
               {/* Earpiece */}
